    ...
    inner class ParseVersionTests {
        ...
        fun shouldParseVersionWithAllComponents() {
            ...
            val expected = Version(
                1, 2, 3, null, PreReleaseVersion("RC", 1),
    ...
    inner class ConstructorTests {
        ...
        inner class VersionComparatorTests {
            ...
            fun shouldCompareVersionsByPreReleaseVersionWhenOtherComponentsAreEqual() {
                val v1 = Version(1, 1, 1, null, PreReleaseVersion("alpha", 2), null, DEFAULT_CONFIG)
                val v2 = Version(1, 1, 1, null, PreReleaseVersion("alpha", 1), null, DEFAULT_CONFIG)
                val v3 = Version(1, 1, 1, null, null, null, DEFAULT_CONFIG)
            ...
            fun shouldHandleComplexVersionComparisons() {
                ...
                val v2 = Version(1, 9, 9, 9, PreReleaseVersion("alpha", 1), null, DEFAULT_CONFIG) // 1.9.9.9-alpha1
                val v3 = Version(1, 9, 9, 9, null, null, DEFAULT_CONFIG) // 1.9.9.9
                val v4 = Version(1, 9, 9, null, PreReleaseVersion("beta", 2), null, DEFAULT_CONFIG) // 1.9.9-beta2
            ...
            fun shouldHandleVersionsWithAllComponents() {
                val v1 = Version(1, 2, 3, 4, PreReleaseVersion("alpha", 1), Snapshot("SNAPSHOT", "meta"), DEFAULT_CONFIG)
                val v2 = Version(1, 2, 3, 3, PreReleaseVersion("alpha", 1), Snapshot("SNAPSHOT", "meta"), DEFAULT_CONFIG)
            ...
            fun shouldTreatNullPreReleaseAsIntMaxValue() {
                ...
                val v2 = Version(1, 1, 1, null, PreReleaseVersion("alpha", Int.MAX_VALUE), null, DEFAULT_CONFIG)
            ...
            fun shouldSortVersionsCorrectly() {
                val versions = listOf(
                    ...
                    Version(1, 0, 0, null, PreReleaseVersion("alpha", 1), null, DEFAULT_CONFIG)
                )
            ...
            fun shouldHandleIdenticalVersions() {
                val v1 = Version(1, 2, 3, 4, PreReleaseVersion("alpha", 1), Snapshot("SNAPSHOT", "meta"), DEFAULT_CONFIG)
                val v2 = Version(1, 2, 3, 4, PreReleaseVersion("alpha", 1), Snapshot("SNAPSHOT", "meta"), DEFAULT_CONFIG)
            ...
            fun shouldHandleEdgeCaseWithMaximumValues() {
                val v1 = Version(
                    ...
                    PreReleaseVersion("alpha", Int.MAX_VALUE), null, DEFAULT_CONFIG
                )
                val v2 = Version(
